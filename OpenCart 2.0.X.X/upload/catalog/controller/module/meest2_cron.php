 ...
 * Usage: 
 * Add to crontab: 
 * 0 2 * * * curl "https://yourdomain.com/index.php?route=module/meest2_cron/updateAll&key=YOUR_SECRET_KEY"
 * 
 * Or use wget:
 * 0 2 * * * wget -q -O /dev/null "https://yourdomain.com/index.php?route=module/meest2_cron/updateAll&key=YOUR_SECRET_KEY"
 */
class ControllerModuleMeest2Cron extends Controller {
    ...
    private function importBranches() {
        ...
        $this->model_shipping_meest2->saveBranchesBatch($responseData['result']);
